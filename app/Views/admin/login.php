<div class="container" style="max-width:500px; padding:40px 20px;">
    ...
    <form action="<?php echo BASEURL; ?>auth/adminLogin" method="POST" style="background:white; padding:20px; border-radius:8px; box-shadow:0 6px 20px rgba(0,0,0,0.08);">
        ...
        <div style="margin-top:15px; text-align:center; font-size:13px;">
            <a href="<?php echo BASEURL; ?>auth/login" style="color: #2563eb;">Login sebagai User</a>
        </div>
    </form>
</div>